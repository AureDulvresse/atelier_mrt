    ...
    <div class="container">
        <div class="artwork-details__grid">
            <div class="artwork-details__image" data-aos="fade-up" data-aos-duration="2000">
                <img src="/atelier_mrt/<?php echo ($artwork->thumbnail != null) ? htmlspecialchars($artwork->thumbnail) : "assets/images/sample.jpg"; ?>" alt="<?php echo htmlspecialchars($artwork->title); ?>" />
            </div>
